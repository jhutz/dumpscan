...
void emit(void)
{
  ...
  dumphdr.volid = 1;
  dumphdr.volname = (unsigned char*)"root.afs";
  dumphdr.from_date = 0;
  ...
  volhdr.volid = 1;
  volhdr.volvers = 1;
  volhdr.volname = (unsigned char*)"root.afs";
  ...
  volhdr.offline_msg = (unsigned char*)"Generated by genrootafs";
  volhdr.motd_msg = (unsigned char*)"";
